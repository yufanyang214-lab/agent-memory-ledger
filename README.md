...
When the user says "archive this session with Agent Memory Ledger",
...
2. Extract durable semantic facts, reusable procedures, and dated events into a
...
has separately enabled an automatic policy. Do not expose the full bright
